...
CREATE Procedure [dbo].[Copy_PathwayG]
				@OrganizationId		Int,
...
*********************************************************************/
	...
	-- Generate pathway body 
			...
			Update @t set OrderCheckSum = CheckSum([Order])

select * from @t  
select * from @t where OrderCheckSum in ( Select OrderCheckSum from dbo.OrderCategory)
